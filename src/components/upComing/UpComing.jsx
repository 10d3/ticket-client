...
function UpComing({data}) {
  ...
  return (
    <div className=" w-full md:w-[66rem] h-fit flex flex-col items-center mb-16">
        ...
        <div className="flex flex-col md:flex-row flex-nowrap w-3/4 md:w-fit h-fit gap-4">
          <div className="flex flex-col w-full md:w-fit">
            ...
            <select
              ...
              onChange={(e)=>{setPent(e.target.value)}}
            >
      ...
      <button className=" text-[#3D37F1] border border-[#3D37F1] p-2 w-fit rounded-md">Load More</button>
    </div>
  );
}
